...
class CollegeDetailsScreenWeb extends StatefulWidget {
  const CollegeDetailsScreenWeb({super.key, required this.argument});

  final argument;

  @override
  State<CollegeDetailsScreenWeb> createState() =>
      _CollegeDetailsScreenWebState();
}

class _CollegeDetailsScreenWebState extends State<CollegeDetailsScreenWeb> {
                    ...
                    child: SizedBox(
                      ...
                      child: GridView.builder(
                        gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                            childAspectRatio: 11, crossAxisCount: 2),
                        itemCount: widget.argument.event.length,
                        itemBuilder: (context, index) {
                          return Align(
                              child: Text(widget.argument.event[index]));
                        },
                      ),
                    ),
                  ),
